...
{
    /// <summary>Captures managed sources before the build, not retroactively from an old Player.</summary>
    public static class H1ManagedSourceProvenance
    {
        ...
        public static string End(Context context, string inputSnapshot, AssemblySnapshotReceipt captured, string sourcePinSha256)
        {
            ...
            // A source ledger is not automatically a source-to-binary PASS.
            // The separate Python verify command and M08 consume the raw graph.
