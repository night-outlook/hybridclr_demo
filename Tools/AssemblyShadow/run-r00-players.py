...
from r00_results import MODES, OFF_MODE

_spec = importlib.util.spec_from_file_location("m07_player_runner", Path(__file__).with_name("run-m07-players.py"))
...
def main(argv=None):
    ...
    receipt = {"schemaVersion": 1, "milestone": "R00", "diagnosticOnly": True,
