...
`bbd836747b6d5c8a2d00041d77b2042ca3ccce1b`
...
| --- | --- | --- |
| Candidate source / implementation | `night-outlook/hybridclr_demo` / `codex/assembly-shadow-r01b-h1` | `bbd836747b6d5c8a2d00041d77b2042ca3ccce1b` |
...
`ProjectSettings/AssemblyShadowSourcePins.json` pins source anchor `bbd836747b6d5c8a2d00041d77b2042ca3ccce1b`. The final branch HEAD is a later metadata-only handoff successor; record both checkout HEAD and source anchor.
...
1. Pull the final candidate handoff HEAD; record checkout HEAD and source anchor `bbd836747b6d5c8a2d00041d77b2042ca3ccce1b` separately.
...
Run a fresh candidate ON/Debug schema-3 normal-cache proof under source anchor `bbd836747b6d5c8a2d00041d77b2042ca3ccce1b`. Preserve normal Bee cache and require strict native compiler/PCH/store/managed/fresh-Player/restoration controls. Do not substitute legacy prior-proof reuse.
