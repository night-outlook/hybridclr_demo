...
`3543c16d7a03f8f120c9ac10324aa10724d5a1ec`
...
| --- | --- | --- |
| Candidate source / implementation | `night-outlook/hybridclr_demo` / `codex/assembly-shadow-r01b-h1` | `3543c16d7a03f8f120c9ac10324aa10724d5a1ec` |
...
`ProjectSettings/AssemblyShadowSourcePins.json` pins source anchor `3543c16d7a03f8f120c9ac10324aa10724d5a1ec`. The final branch HEAD is a later metadata-only handoff successor; record both checkout HEAD and source anchor.
...
1. Pull the final candidate handoff HEAD; record checkout HEAD and source anchor `3543c16d7a03f8f120c9ac10324aa10724d5a1ec` separately.
...
Run a fresh candidate ON/Debug schema-3 normal-cache proof under source anchor `3543c16d7a03f8f120c9ac10324aa10724d5a1ec`. Preserve normal Bee cache and require strict native compiler/PCH/store/managed/fresh-Player/restoration controls. Do not substitute legacy prior-proof reuse.
