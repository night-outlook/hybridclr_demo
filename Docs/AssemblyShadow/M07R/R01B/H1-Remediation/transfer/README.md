...
|---|---|---|---|---|
| Candidate demo | `https://github.com/night-outlook/hybridclr_demo/tree/codex/assembly-shadow-r01b-h1` | `codex/assembly-shadow-r01b-h1` | `06c2ee6` (checkpoint; source pin was `9c6b812148f5ec640e57ecbedcf9399ce68e6aaa`) | clean for committed scope; historical v7-v11 evidence remains untracked |
| Candidate native | `https://github.com/night-outlook/hybridclr/tree/codex/assembly-shadow-r01b-h1` | `codex/assembly-shadow-r01b-h1` | `1d2df7c` (checkpoint; active source pin was `67f80ac01c15004ed9d2f0c884d0d92141d1019a`) | clean for committed scope |
| Candidate Unity package | `https://github.com/night-outlook/hybridclr_unity/tree/codex/assembly-shadow-r01b-h1` | `codex/assembly-shadow-r01b-h1` | `c7ed6d244a2c3a8e948f062d5431c289e1369650` | clean |
| Candidate IL2CPP Plus | `https://github.com/night-outlook/il2cpp_plus/tree/codex/assembly-shadow-r01b-h1` | `codex/assembly-shadow-r01b-h1` | `6be7f38bec2fa4677d24efc1a4a1294240789933` | clean |
| Frozen build native | `https://github.com/night-outlook/hybridclr/tree/db685e44afb5aee440efae2eb7bec4205aac090d` | detached/pinned checkout | `db685e44afb5aee440efae2eb7bec4205aac090d` | clean; keep separate from active native work |
| Performance reference demo | `https://github.com/night-outlook/hybridclr_demo/tree/codex/assembly-shadow-h1-performance-reference` | `codex/assembly-shadow-h1-performance-reference` | `88508b5` (checkpoint; reference pin `f1c923cbaa814e1b63f3c5b9f8303c90616de726`) | clean for committed scope |
| Unfixed reproduction demo | `https://github.com/night-outlook/hybridclr_demo/tree/codex/assembly-shadow-h1-count-repro` | `codex/assembly-shadow-h1-count-repro` | `c8ced4a` (checkpoint; source pin `3efc756f7c95ef6699fe838ddda3fdfffc856b53`) | clean for committed scope |
| Unfixed reproduction native | `https://github.com/night-outlook/hybridclr/tree/codex/assembly-shadow-h1-count-repro` | `codex/assembly-shadow-h1-count-repro` | `99cdb1b` (checkpoint; active source pin `6356dac1df87f601b2d7eb44c9c2ce13b06aa19b`) | clean for committed scope |

The original checkout `https://github.com/night-outlook/hybridclr_demo/tree/main` is on `main` at `73d95b4064ee23143e0722f6eae127fe61df6c9d` and contains three unrelated local changes. Do not stage or clean it.
